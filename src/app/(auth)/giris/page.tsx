    ...
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-green-700 via-green-600 to-emerald-800 p-4">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-card p-8 shadow-xl">
        ...
        <div className="mb-6 text-center">
          <Link
            href="/"
            className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-green-100 text-green-700 dark:bg-green-500/15 dark:text-green-400"
            aria-label={tl("backHome")}
          >
        ...
        {/* The four showcase accounts; shared with the landing page. */}
        <DemoRoleButtons />
        ...
        {/* A visitor who arrives here from a CV has no other route to the code. */}
