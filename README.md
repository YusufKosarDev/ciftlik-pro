...
[![Tests](https://img.shields.io/badge/tests-169%20unit%20%2B%207%20e2e-success)](#test--kalite)
...
- **Test & CI/CD** — 169 birim/bileşen testi (Vitest + Testing Library) + 7 uçtan uca test (Playwright),
...
- **Birim testleri (Vitest):** doğrulama şemaları, RBAC yetkilendirme,
  ...
  Badge/Button/EmptyState/DataTable/OnboardingModal) — `npm test` (169 test). Kapsam raporu için
